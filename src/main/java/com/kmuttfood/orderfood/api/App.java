...
public class App {
    ...
    public String viewOrderPage(@PathVariable("id") Integer id, OrderCustomer orderDetail, Model model,
    ...
    public String processOrderToRastaurant(
        ...
        orderSevice.updateTimelistOrders(time, status2);
        orderSevice.updateDatelistOrders(date, status2);
