...
public class OrderSevice {
    ...
    public void updateDatelistOrders(Date date, Status status2) {
        orderCustomerRepo.updateDatelistOrder(date, status2);
    }

    public void updateTimelistOrders(Time time, Status status2) {
        orderCustomerRepo.updateTimelistOrder(time, status2);
    }
